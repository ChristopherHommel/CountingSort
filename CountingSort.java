...
public class CountingSort {
	...
	/**
	 * Creates the upper and lower bounds for starting the sort
	 * 
	 * @param array Pass in an array of unsorted values
	 */
	...
	/**
	 * Calculates and repositions each parameter in the array
	 * 
	 * @param array    Array to be sorted
	 * @param minValue minimum value for the sort
	 * @param maxValue maximum value for the sort
	 */
	public void countingSort(int[] array, int minValue, int maxValue) {
		...
		// and decrease count at each given position by 1 until there is nothing in the
		// temp array
